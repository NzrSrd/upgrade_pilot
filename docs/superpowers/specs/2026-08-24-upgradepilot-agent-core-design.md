...
2. **Knowledge base** — real Chroma, deterministic fake embedding function, fixture corpus. Scalar filters, symbol post-ranking, and the golden set asserted against recall@5 and MRR floors.
